...
public class EmailService {
    ...
    private String buildVerificationHtml(String link, long ttlMinutes) {
        ...
        String heading = "<h1 style=\"margin: 0 0 10px 0; font-size: 22px; font-weight: 700; color: #1e293b;"
                + " font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif;"
                + " text-align: center;\">"
                + "Xác thực tài khoản của bạn</h1>";

        String body = "<div style=\"margin-bottom: 28px; text-align: center;\">"
                + "<p style=\"margin: 0 0 6px 0; font-size: 16px; color: #475569; line-height: 1.7;\">"
                + "Cảm ơn bạn đã đăng ký <strong style=\"color: #1e293b;\">" + SYSTEM_NAME + "</strong>.</p>"
        ...
        String button = "<div style=\"text-align: center; margin-bottom: 28px;\">"
                + "<a href=\"" + link + "\""
                + " style=\"display: inline-block; padding: 14px 36px; background: #c9a84c; color: #ffffff;"
                + " text-decoration: none; font-size: 16px; font-weight: 700; border-radius: 8px;"
                + " box-shadow: 0 4px 14px rgba(201, 168, 76, 0.35);\">"
                + "Xác thực tài khoản</a></div>";

        String fallback = "<div style=\"margin-bottom: 24px; padding: 16px; background: #f8fafc; border-radius: 8px;"
        ...
        String expiry = "<div style=\"margin-bottom: 4px; padding: 14px 16px; background: #fffbeb; border-radius: 8px;"
                + " border: 1px solid #fde68a; text-align: left;\">"
    ...
    private String buildPasswordResetHtml(String link) {
        ...
        String body = "<div style=\"margin-bottom: 28px; text-align: center;\">"
                ...
                + "<strong style=\"color: #1e293b;\">" + SYSTEM_NAME + "</strong>.</p>"
                + "<p style=\"margin: 0; font-size: 16px; color: #475569; line-height: 1.7;\">"
    ...
    private String wrapInTemplate(String content) {
        return "<!DOCTYPE html>\n"
                ...
                + "padding:24px 32px;border-radius:0 0 16px 16px;text-align:center;\">\n"
