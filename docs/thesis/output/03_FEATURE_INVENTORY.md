...
| FEAT-02 | Browse/search/filter/timeline | AllEventsPage, visible exact-year input, Timeline and `/api/events`, `/api/timeline` | IMPLEMENTED_AND_VERIFIED (static/tests/build) | frontend/src/App.tsx; Timeline.tsx; MapPage.tsx |
...
| FEAT-08 | Quiz and AI generation | Spring authenticated gateway; FastAPI retrieval/generation; bounded factual guard | IMPLEMENTED_AND_OFFLINE_VERIFIED; PROVIDER_DEPENDENT | AiQuizController; ai-service/app/api; factual_guard |
...
| FEAT-14 | RAG evaluation | 60 retrieval cases plus 27 paired generation tasks/54 outputs | TECHNICAL_EVALUATION_COMPLETED; FIXED_BENCHMARK | docs/review/fix-teacher/rag01-final |

Final qualification: the core map/timeline/content/exam product remains useful without generative AI. Dashboard personalization is a rule-based weakness/developing recommendation, not ML/adaptive learning. No learner educational-effectiveness study was performed.
