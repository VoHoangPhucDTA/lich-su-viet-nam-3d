---
description: Tự động load learnings từ .agent/.agent/learnings/ ở đầu mỗi session
...
1. **Đọc danh sách file** trong `.agent/.agent/learnings/` (chỉ tên file, KHÔNG đọc nội dung).
