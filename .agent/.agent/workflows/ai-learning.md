---
description: Lưu learnings từ conversation hiện tại vào .agent/.agent/learnings/ theo chủ đề
---
...
AI **PHẢI** đọc danh sách file trong `.agent/.agent/learnings/` trước tiên để biết những feature nào đã có file.
...
### File path: `.agent/.agent/learnings/[feature-name].md`
...
```
✅ Đã lưu learnings vào: .agent/.agent/learnings/[feature-name].md
