...
export default function ExamShortcutHelp({ id, isOpen, onClose, triggerRef, shortcuts, title = 'Hướng dẫn làm bài', description, notes }: ExamShortcutHelpProps) {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div id={descriptionId} className="exam-shortcut-help-description">{description ?? 'Danh sách phím tắt dùng trong chế độ làm bài này.'}</div>
