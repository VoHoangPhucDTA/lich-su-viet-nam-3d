...
export function DashboardQuickActions({
  ...
  const actions = [
    { label: 'Duyệt kho đề', description: 'Chọn một đề thi phù hợp', route: '/exams/browse' },
    { label: 'Tạo đề tùy chọn', description: 'Tự chọn cấu trúc bài thi', route: '/exams/tao-de' },
    ...(topicRoute ? [{ label: 'Ôn chủ đề yếu', description: 'Luyện phần cần cải thiện', route: topicRoute }] : []),
    { label: 'Xem toàn bộ lịch sử', description: 'Mở danh sách bài đã làm', route: '/exams/lich-su' },
  ];
