    ...
    >
      <section className="dashboard-card dashboard-activity-card" aria-labelledby="dashboard-utility-title">
        ...
        <div className="dashboard-activity-stats">
          <article><strong>{vm.summary.activeDays}</strong><span>ngày hoạt động</span></article>
          <article><strong>{formatDashboardDuration(vm.summary.totalDurationSeconds)}</strong><span>tổng thời gian</span></article>
        </div>
