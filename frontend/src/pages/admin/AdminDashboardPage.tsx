...
export default function AdminDashboardPage() {
  ...
  const columns: AdminDataColumn<AdminEvent>[] = [
    ...
    },
    {
      key: 'period',
      header: 'Th\u1eddi k\u1ef3',
      render: event => <span className="text-xs text-[var(--text-secondary)]">{getEventPeriod(event.startYear)?.shortLabel ?? 'Ch\u01b0a ph\u00e2n k\u1ef3'}</span>,
    },
    {
      key: 'level',
      header: 'C\u1ea5p \u0111\u1ed9',
