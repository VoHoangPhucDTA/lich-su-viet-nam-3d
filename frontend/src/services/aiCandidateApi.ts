...
import type { AiCandidateAuditEvent, AiCandidateDetail, AiCandidatePage, AiPublishTarget } from '@/types/aiCandidate';
...
export function approveAiCandidate(id: string, version: number, note?: string) { return apiPostOnce<AiCandidateDetail>(`${BASE}/${encodeURIComponent(id)}/approve`, { version, note }); }
